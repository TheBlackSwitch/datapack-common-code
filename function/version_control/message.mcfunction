...
tellraw @a [{"text":" Possible solutions:","bold": true}]

tellraw @a [{"text": " - Upgrade ","color":"green"},{"nbt":"lib.loaded_from","storage":"theblackswitch:versions","color":"gold"}, {"text":" to the latest version","color":"green"}]

tellraw @a [{"text": " - Downgrade ","color":"yellow"},{"nbt":"current_pack.pack","storage":"theblackswitch:temp","color":"gold"},{"text":" to a version compatable with ","color":"yellow"}, \
{"nbt":"lib.loaded_from","storage":"theblackswitch:versions","color":"gold","extra": [" (if that exists)\n"]}]

data modify storage theblackswitch:versions compatable set value 0b